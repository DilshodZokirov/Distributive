...
from api.office_manager.serializers.worker import UserSalarySerializer, UserMoveSerializer, WorkerUserAllSerializer
from api.utils.serializer import DistrictEmployeeSerializer
...
class ManagerWorkerModelApiViewSet(ModelViewSet):
    ...
    def profile_manager(self, request, *args, **kwargs):
    ...
    def worker_list(self, request, *args, **kwargs):
        ...
        queryset = User.objects.filter(Q(company=company) & (Q(role="agent")))
